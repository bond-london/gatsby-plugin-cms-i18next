...
- Based on gatsby-plugin-react-i18next, but uses the CMS for locales
...
The original plugin generated locale pages itself, rather than getting them from the CMS
...
```
yarn add @bond-london/gatsby-plugin-cms-i18next i18next react-i18next
```
...
`gatsby-plugin-cms-i18next` exposes all [`react-i18next`](https://react.i18next.com/) methods and components.
...
- [gatsby-plugin-react-i18next](https://raw.githubusercontent.com/microapps/gatsby-plugin-react-i18next) by microapps

## License

MIT &copy; [Bond London](https://github.com/bond-london)
